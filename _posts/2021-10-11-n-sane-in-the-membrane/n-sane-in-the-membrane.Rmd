...
Well I guess the first question is _is there a distinction_? Let's do the sort of R experiment I want my students to do!
...
$$ This does not compare well against the sampling variance, which (assuming $\sigma^2=1$) is about $0.3$.
...
But in real life, bias is the price you pay for being good at statistics. And like any market, if you pay too much you’re maybe not that good. But if you pay nothing at all, you don’t get to play.
