...
for an unknown function" thing but once you relax into it^[I recomend some video head cleaner], 
...
definition operationalised in book's like Rasmussen and Williams^[Great book. 
...
formulas for almost everything we want to have formulas for] distributions in 
...
aren't admissible for $H$ (for example, $a_n = \sqrt{n}$).
