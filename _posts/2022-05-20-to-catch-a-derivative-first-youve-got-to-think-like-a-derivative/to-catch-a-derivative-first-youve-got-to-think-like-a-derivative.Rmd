---
title: "Sparse matrices part 6: To catch a derivative, first you've got to think like a derivative"
description: |
...
repository_url: https://github.com/dpsimpson/blog/tree/master/_posts/2022-05-20-to-catch-a-derivative-first-youve-got-to-think-like-a-derivative
draft: false
---
...
## Primitive 3: The dreaded log determinant
...
then $VDV^TS = I$.  Then, we make some magic manipulations^[Thnks to Jerzy Baranowski for finding a very very bad LaTeX erro that made these queations quite wrong!].
\begin{align*}
V^TS &= D^{-1}V^{-1} \\
S + V^TS &= S + D^{-1}V^{-1} \\
S &= D^{-1}V^{-1} + (I - V^T)S.
