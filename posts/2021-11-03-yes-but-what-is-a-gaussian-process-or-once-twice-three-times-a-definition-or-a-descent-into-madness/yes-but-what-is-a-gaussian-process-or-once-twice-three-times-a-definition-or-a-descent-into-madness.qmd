...
categories: [Gaussian processes, Fundamentals, Theory, Deep dive]
twitter-card:
  title:  "Yes but what is a Gaussian process? or, Once, twice, three times a definition; or A descent into madness"
...
::: {#thm-stochastic-process} 
A stochastic process $u(\cdot)$ is a Gaussian process if and only
if 
$$
...
::: {#def-cameron-martin}
The Cameron-Martin space (or reproducing kernel Hilbert space, 
...
::: {#thm-cylindrical}
Let $H$ be a separable Hilbert space and let $B$ be a separable
