...
g <- graph(edges = c(1,2,1,4,2,4,3,4), n = 4, directed = FALSE )
plot(g)
```
...
#| echo: false
#| warning: false
gfill <- graph(c(1,2,1,3,1,4,1,5,1,6), n = 6, directed = FALSE)
plot(gfill)
```
...
gfill <- graph(c(1,6,2,6,3,6,4,6,5,6), n = 6, directed = FALSE)
plot(gfill)
```
